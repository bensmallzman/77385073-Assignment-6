...
const actors = [
  ...
  function introduceTheActors(actorArray)
  {
      ...
      {
          let statement = "Hi, I'm ${i.name} and I was in ${i.movie}."
  ...
  {
      const array = [];
      // return obj value for each element in array but method
  ...
  function goToSecondClass(obj)
  {
      return "Time to go to ${obj.secondHour} class!";
  }
